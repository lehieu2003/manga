...
- Catalog chapter reads are now DB-first, while MangaDex import/sync is handled by scripts and admin sync endpoints. The completed separation is tracked in `docs/catalog-data-workflow/README.md`.
